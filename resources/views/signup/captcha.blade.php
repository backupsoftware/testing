...
@section('content')
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('asset/css/Signup-Form/captcha.css') }}">
    ...
    <body>
        <div class="container mt-5">
            <form id="signupForm" action="#" method="POST" class="form-card shadow p-4 rounded bg-light">
                @csrf
                <h1 class="mb-4 text-center">Captcha Signup Form    </h1>
                ...
                <!-- CAPTCHA Field (Initially Hidden) -->
                <div class="mb-3" id="captchaField" style="display: none;">
                    <div class="g-recaptcha" data-sitekey="6Ldf7JUqAAAAANTT8QavKhDiIIE9vaVb1Hq_yNyP"></div>
                </div>
        ...
        <script src="{{ asset('asset/js/Signup-Form/captcha.js') }}"></script>
    </body>
