...
@section('content')
    ...
    <head>
        ...
        <meta property="og:description" content="Create a new account easily using our simple signup form.">
        ...
        <meta name="twitter:description" content="Signup and create your account easily.">
    ...
    <body>
        <div class="container mt-5">
            <form id="signupForm" action="{{ route('signup.post') }}" method="POST" class="form-card shadow p-4 rounded bg-light">
                @csrf
                <h1 class="mb-4 text-center">Basic Signup Form</h1>
        ...
        <!-- Custom JavaScript for Password Strength and Toggle -->
